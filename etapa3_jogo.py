import random
from .etapa2_perguntas import carregar_perguntas, sortear_pergunta  # Import relativo

# Controle de ajudas (pode ser reinicializado no reinício do jogo)
ajudas = {
    "dica": 1,
    "pular": 1,
    "eliminar": 1
